function [logalpha,loglik]=HMMforwardGMM(v,phghm,ph1,m,sigma2,Tskip)
...
for t=2:T
	...
	logalpha(:,t)=brml.logsumexp(repmat(logalpha(:,t-1),1,H),repmat(phatvgh',H,1).*phghmt');
end
loglik = brml.logsumexp(logalpha(:,T),ones(H,1)); % log likelihood